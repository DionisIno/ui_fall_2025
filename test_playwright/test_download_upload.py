...
def test_download(driver_demoqa):
    driver_demoqa.goto(url="upload-download", wait_until="domcontentloaded")

    download_btn_loc = "a[id='downloadButton']"
    download_file_path = r"E:\Program\PyCharm_program\red_rover\fall_2025\ui\download"
...
def test_upload(driver_demoqa):
    ...
    file_path = r"E:\Program\PyCharm_program\red_rover\fall_2025\ui\download\sampleFile.jpeg"
